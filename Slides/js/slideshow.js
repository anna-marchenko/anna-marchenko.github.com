(function(a){
    a.fn.slideshow=function(p){
        ...
        var o=p&&p.slideshow_time_interval?p.slideshow_time_interval:"3000";
        var q=p&&p.slideshow_window_background_color?p.slideshow_window_background_color:"#ccc";
        var r=p&&p.slideshow_window_padding?p.slideshow_window_padding:"1";
        var s=p&&p.slideshow_window_width?p.slideshow_window_width:"600";
        ...
        var H=p&&p.slideshow_show_title?p.slideshow_show_title:"disable";
        var x=p&&p.slideshow_button_text_color?p.slideshow_button_text_color:"red";
        var z=p&&p.slideshow_button_background_color?p.slideshow_button_background_color:"#aaa";
        var A=p&&p.slideshow_button_current_background_color?p.slideshow_button_current_background_color:"white";
        var B=p&&p.slideshow_button_border_color?p.slideshow_button_border_color:"black";
        var C=p&&p.slideshow_button_border_size?p.slideshow_button_border_size:"1";
        var s_l_g=p&&p.slideshow_loading_gif?p.slideshow_loading_gif:"img/slide/loading.gif";
        var first = false;
        r += "px";
        s += "px";
        t += "px";
